          ...
          <div className="flex flex-wrap items-center -mx-4">
            <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
              <div className="max-w-md">
                ...
                <h2 className="mt-8 mb-12 text-5xl font-bold font-heading text-white leading-tight">
                  {isRegister
                    ? "Create an account and start pending down your ideas"
                    : "Login to your account and start pending down your ideas"}
                </h2>
              </div>
            </div>
            <div className="w-full lg:w-1/2 px-4">
              <div className="px-6 lg:px-20 py-12 lg:py-24 bg-gray-600 rounded-lg">
                <form onSubmit={formik.handleSubmit}>
                  ...
                  <div className="text-xl text-white font-light mb-6">
                    {isRegister
